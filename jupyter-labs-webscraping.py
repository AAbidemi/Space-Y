...
keys_to_initialize = ['Flight No.', 'Launch site', 'Payload', 'Payload mass', 'Orbit', 'Customer', 'Launch outcome', 'Version Booster', 'Booster landing', 'Date', 'Time']
for key in keys_to_initialize:
    launch_dict[key] = []

# Now you can convert this dictionary into a Pandas DataFrame
import pandas as pd
